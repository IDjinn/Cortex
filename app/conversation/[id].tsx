...
import { AssistantBubble, UserBubble } from '@/components/chat';
...
export default function ConversationScreen() {
  ...
  const pendingInitialRef = useRef<string | null>(
    params.initial ? decodeURIComponent(params.initial) : null,
  );
  ...
  // Auto-send the initial message that was passed in from the home screen.
  useEffect(() => {
